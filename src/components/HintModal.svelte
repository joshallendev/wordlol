...
<div 
    ...
    <div class="flex flex-row mb-4">
        ...
        <section class="flex flex-col items-center">
            {#if !$revealType }
                <button type="button" class="bg-lightgray rounded mb-6 p-2" on:click={() => $revealType = !$revealType}>
                    ✨ show me the hint! ✨
                </button>
            {:else}
            ...
            <section class="flex flex-col items-center">
                {#if $revealType && !$revealClue }
                    <button type="button" class="block bg-lightgray rounded mb-6 p-2" on:click={() => $revealClue = !$revealClue}>
